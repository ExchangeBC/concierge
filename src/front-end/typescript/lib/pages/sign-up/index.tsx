      ...
      <Row className='justify-content-center mb-4 mb-md-5'>
        <Col xs='12' sm='8' md='5' className='mb-4 mb-md-0'>
          <Card body className='py-5 px-4 px-lg-5 text-center shadow-sm h-100 d-flex flex-column justify-content-center'>
            ...
            <Link button route={{ tag: 'signUpBuyer', value: null }} color='primary' className='mt-md-auto w-100'>Select</Link>
          </Card>
        </Col>
        <Col xs='12' sm='8' md='5'>
          <Card body className='py-5 px-4 px-lg-5 text-center mb-3 mb-md-0 shadow-sm h-100 d-flex flex-column align-items-center justify-content-center'>
            ...
            <Link button route={{ tag: 'signUpVendor', value: null }} color='primary' className='mt-md-auto w-100'>Select</Link>
          </Card>
        </Col>
      </Row>
      <Row>
