The Procurement Concierge Program (the “Program”) is a key component of the Province of [British Columbia’s Procurement Strategy](https://www2.gov.bc.ca/assets/gov/government/services-for-government-and-broader-public-sector/buy-goods-services-and-construction/support-services/bc_procurement_strategy_2018.pdf).  It empowers the Province’s Procurement Transformation Branch to make meaningful connections between public-sector buyers with unique business problems and vendors with innovative solutions by facilitating market sounding to gather information that could assist the Province and public-sector buyers in the procurement planning process. It achieves this by facilitating better communication between both groups through Requests for Information (“RFI”) and Discovery Day Sessions.
...
As a public-sector buyer, you can use the Concierge Web App to engage with vendors as part of the pre-planning of a procurement process. By using the Concierge Web App, and with the support of the Program, you will be able to create an account, post a RFI for your business problem, and offer Discovery Day Sessions to vendors.  You will also be able to see vendor profiles, but vendors aren’t able to see the public-sector buyer profiles.

### (i) How to Create an Account

As a public-sector buyer, you can either create your own account or request that the Program create one on your behalf.

If you wish for your account to be set up on your behalf, please contact the Program at [Procurement.Concierge@gov.bc.ca](mailto:Procurement.Concierge@gov.bc.ca). Otherwise, please follow the steps below to create your own account.
...
The available “Areas of Interest” are based on the “Commodity Codes” used by BC Bid ([www.bcbid.gov.bc.ca](www.bcbid.gov.bc.ca)). “Commodity Codes” are a standard classification of goods and services used by the Province.
...
Once you have agreed to accept the Terms and Conditions, your registration will be complete and you will receive full access to the benefits and features of the Concierge Web App, including the ability to issue RFIs and participate in Discovery Day Sessions.
...
A complete listing of RFIs posted through the Concierge Web App can be viewed [here](/requests-for-information) (or by clicking the “RFIs” link at the top of the page).  The details of an RFI can be viewed by clicking on its “Project Title”.
...
If you are interested in posting an RFI, please email your request to [Procurement.Concierge@gov.bc.ca](mailto:Procurement.Concierge@gov.bc.ca). The Program will work with you to develop and manage your RFI.
...
As a vendor, you will be able to connect with public-sector buyers by creating an account, viewing RFIs posted by registered public-sector buyers, responding to RFIs and registering for Discovery Day Sessions. By participating in these activities you can learn about the business problems of registered public-sector buyers and share your innovative ideas and potential solutions. 

### (i) How to Create an Account

This is a step-by-step guide on how to create an account with the Concierge Web App:
...
The available “Areas of Interest” are based on the “Commodity Codes” used by BC Bid ([www.bcbid.gov.bc.ca](www.bcbid.gov.bc.ca)).  “Commodity Codes” are a standard classification of goods and services used in the Province.
