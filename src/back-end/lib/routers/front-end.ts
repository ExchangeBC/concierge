...
import { FileResponseBody, makeTextResponseBody, Route, Router, TextResponseBody, tryMakeFileResponseBodyWithGzip } from 'back-end/lib/server';
import { join, resolve } from 'path';
import { HttpMethod } from 'shared/lib/types';

const FALLBACK_FILE_PATH = join(FRONT_END_BUILD_DIR, 'index.html');

const frontEndAssetRoute: Route<any, null, FileResponseBody | TextResponseBody, null, any> = {
